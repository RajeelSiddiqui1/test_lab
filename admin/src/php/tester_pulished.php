    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                $query = "SELECT t.id, t.full_name, t.email, t.education, t.skills, t.work_experience, t.portfolio_url, t.country, t.image, c.c_name AS category_name
            FROM testers t
            ...
            WHERE t.id = $getid";
                ...
                <form method="POST" enctype="multipart/form-data" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);" class="p-3">
                    ...
                    if (isset($_POST['send'])) {
                        ...
                        // Get the existing image from the hidden input
                        $image = $_POST['image'];

                        // Insert the data into the database
                        $query = "INSERT INTO `show_tester_to_user` (`fullname`, `email`, `education`, `skills`, `work_experince`, `protfolio`, `country`, `image`) 
              VALUES ('$fullName', '$email', '$education', '$skills', '$work_experience', '$portfolio', '$country', '$image')";
