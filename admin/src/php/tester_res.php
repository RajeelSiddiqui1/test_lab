...
<div class="container my-5">
    <div class="row">
        <h2 class="">Tester Login Request</h2>
    </div>
    ...
    <div class="row my-3">
        <div class="table-responsive"> <!-- Added table-responsive class to make it scrollable on smaller screens -->
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                    $query = "SELECT * FROM `testers` WHERE status = 'pending' ORDER BY id ASC";
...
if(isset($_POST['approved'])) {
    ...
    $query = "UPDATE testers SET status = 'approved' WHERE id=$id";
    $result = mysqli_query($conn,$query);
...
if(isset($_POST['deny'])){
    ...
    $query = "DELETE FROM testers WHERE id=$id";
    $result = mysqli_query($conn,$query);
